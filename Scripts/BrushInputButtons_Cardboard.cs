...
public class BrushInputButtons_Cardboard : MonoBehaviour {
	...
	void OnGUI() {
		if (showButtons) {
			...
			if (menuCounter == 1) {
				...
				// 2.
				Rect colorButton = new Rect(BUTTON_GAP_X, Screen.height - (2 * (BUTTON_SIZE_Y - BUTTON_GAP_X)), BUTTON_SIZE_X, BUTTON_SIZE_Y);
